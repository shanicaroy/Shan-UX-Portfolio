import { leadershipProof } from "@/content/leadership";
import Shell from "./Shell";
import SectionIntro from "./SectionIntro";

/** Four-column proof grid. Metrics stay [X] until verified — never invented. */
export default function LeadershipProof() {
  return (
    <Shell as="section" id="leadership" className="scroll-mt-16 pt-20 lg:pt-28">
      <SectionIntro
        label={leadershipProof.label}
        heading={leadershipProof.heading}
        support={leadershipProof.support}
      />

      <div className="mt-12 grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4">
        {leadershipProof.columns.map((col) => (
          <div key={col.label}>
