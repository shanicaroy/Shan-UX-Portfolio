...
export default function HeroExperience() {
  return (
    <Shell as="section" className="grid grid-cols-12 gap-x-8 gap-y-20 pb-28 pt-28 sm:pt-36 xl:pb-40 xl:pt-44">
      {/* Left — headline. From `sm` up, line one is held on a single line so the
          ...
          it wraps naturally rather than overflowing. */}
      <div className="col-span-12 xl:col-span-8">
        <h1 className="display text-[2.25rem] font-medium leading-[1.04] text-ink sm:text-[2.75rem] lg:text-[3.5rem] xl:text-[4rem]">
        ...
        <ul className="mt-8 border-t border-rule">
          {experience.map((entry) => (
            <li
              ...
              className="grid grid-cols-[4.5rem_1fr] items-baseline gap-x-5 gap-y-1 border-b border-rule py-4"
            >
